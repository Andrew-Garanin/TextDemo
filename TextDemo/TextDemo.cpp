...
// TextDemo.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTextDemoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTextDemoApp::OnAppAbout)
...
// Создание CTextDemoApp

CTextDemoApp::CTextDemoApp() noexcept
{
	...
	SetAppID(_T("TextDemo.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CTextDemoApp

CTextDemoApp theApp;


// Инициализация CTextDemoApp

BOOL CTextDemoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTextDemoDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CTextDemoView));
	if (!pDocTemplate)
		return FALSE;
	...
	m_pMainWnd->SetWindowText(_T("Text Demo"));
	return TRUE;
}

// Обработчики сообщений CTextDemoApp
